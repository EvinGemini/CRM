                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>拜访时间：从</TD>
                                    <td>
                                        <s:textfield cssClass="textbox" id="start_time" cssStyle="WIDTH: 80px"
                                                     maxlength="50" name="visit_time" theme="simple" readonly="true"/>
                                    </td>
                                    <TD>到</TD>
                                    <td>
                                        <s:textfield cssClass="textbox" id="end_time" cssStyle="WIDTH: 80px"
                                                     maxlength="50" name="visitEndTime" theme="simple" readonly="true"/>
                                    </td>
